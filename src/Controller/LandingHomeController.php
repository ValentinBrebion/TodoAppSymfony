...
class LandingHomeController extends AbstractController
{
    ...
    {
        return $this->render('landing_home/index.html.twig', [
    ...
    {
        return $this->render('landing_home/todoConnexion.html.twig', [
    ...
    {
        return $this->render('landing_home/todoInscription.html.twig', [
